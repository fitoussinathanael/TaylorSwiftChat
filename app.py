...
# =========================================================
# QUICK ICU (VERSION RÉA STABLE)
# =========================================================
def quick(text):
    t = text.lower()

    hypox = 2 if any(x in t for x in ["dysp", "hypox", "sat", "86%", "85%", "o2"]) else 0
    choc = 3 if any(x in t for x in ["choc", "hypotension", "85/50", "norad"]) else 0
